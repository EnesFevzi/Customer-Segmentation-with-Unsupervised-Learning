...
###############################################################
#Veri setini okutup ve müşterileri segmentlerken kullanıcağınız değişkenleri seçiyoruz.
###############################################################
...
# 1. Değişkenleri standartlaştırması
#SKEWNESS
...
# Çarpıklık var ise ,Normal dağılımın sağlanması için Log transformation uygulanması
...
# 3. Modelinizi oluşturunuz ve müşterilerinizi segmentleme
...
#standarlaştırdığınız dataframe'i kullanarak optimum küme sayısını belirlenmesi
...
# Modelinizi oluşturulması ve müşterilerin segmentlenmesi.
...
# Herbir segmenti istatistiksel olarak incelenmesi
final_df.groupby("segment").agg({"order_num_total_ever_online":["mean","min","max"],
                                  "order_num_total_ever_offline":["mean","min","max"],
                                  "customer_value_total_ever_offline":["mean","min","max"],
                                  "customer_value_total_ever_online":["mean","min","max"],
